...
<form method="POST" action="index.php" name="myform" onsubmit="return validate_f1()">
...
$hours1= array("9 AM","10 AM","11 AM","12 PM","1 PM","2 PM","3 PM","4 PM","5 PM");
$otHours = array("17","18","19");
$otHours1 = array("5 PM","6 PM","7 PM");
...
<tr  "rowa<?php echo $k?>">  
	...
	<td colspan="3">
	   <input type="button" id ="editButton<?php echo $k?>" value="Edit"/ onclick="expand(this)">
	</td>
...
<tr class = "collapsed" id="rowb<?php echo $k?>">  
	...
	<td>
		...
		<select name="HoursEnd[]" id="HoursEnd<?php echo $k?>" onchange="updateHours(this)">
			...
			<select name="MinutesEnd[]" id="MinutesEnd<?php echo $k?>" onchange="updateHours(this)">
			<?php
			for($i=0;$i<60;$i++)
			{
			...
			<select name="SecondsEnd[]" id="SecondsEnd<?php echo $k?>" onchange="updateHours(this)">
				<?php
			for($i=0;$i<60;$i++)
			{

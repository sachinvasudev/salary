...
<br/>
<input type="submit" class ="big" name="generate" value="Generate Form"/>
...
<form method="post" action="process.php" id="form2" onsubmit="return enableElems()" name="form2" />
<input type="hidden" name="days" id ="days" value="<?php echo $days;?>"/>
<input type="hidden" name="startDate" value="<?php echo $d1;?>"/>
<input type="hidden" name="endDate" value="<?php echo $d2 ;?>"/>
...
<tr>
	...
	<td colspan="2">
	   &nbsp;Leave <input type="checkbox" name="markLeave[]" id ="markLeave<?php echo $k?>" value="View" onclick="markLeave(this)">
	</td>
...
<tr class = "collapsed" id="rowb<?php echo $k?>">  
	...
	<td>
		...
		<select name="HoursEnd[]" id="HoursEnd<?php echo $k?>" onchange="updateHours(this)">
			...
			{
			if($val==17)
			echo '<option selected="selected" value="17">05 PM</option>';
			else	
			echo "<option value=\"$val\">$hours1[$key]</option>";
			}
			?></select>
...
<tr class="collapsed" id="rowd<?php echo $k?>">
	...
	<td>
		...
		<select name="otHoursEnd[]" id="otHoursEnd<?php echo $k?>" disabled="disabled" onchange="updateHours(this)">
			...
			{
			if($val==19)
			echo '<option selected="selected" value="19">07 PM</option>';
			else	
				echo "<option value=\"$val\">$otHours1[$key]</option>";
			}
			?></select>
	...
	<td>
		 <input name="otHours[]" id="otHours<?php echo $k?>" disabled="disabled" type="text"  size="2"value="0.0"readonly="readonly"/>
